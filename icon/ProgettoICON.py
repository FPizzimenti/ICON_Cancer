...
cancer = data.query(variables = ['diagnosis'],
                       evidence={'radius_mean': 15,'texture_mean':23,'perimeter_mean':80,'area_mean':1001,'radius_se':0,'perimeter_se':6,'area_se':50, 
                      'radius_worst':25,'texture_worst':32,'perimeter_worst':170,'area_worst':1606, 
